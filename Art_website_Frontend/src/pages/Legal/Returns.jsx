    ...
    return (
        <>
            <div className="flex m-10 gap-2">
                <NavLink to={'/help-center'}><p className="underline hover:text-teal-600">Help Center</p></NavLink>
                <p> / </p>
                <NavLink to={`/returns`}><p className="underline hover:text-teal-600">Return Policy</p></NavLink>
            </div>
            <div className="md:m-20 m-14 mt-5">
                ...
                <div className="md:m-44 mt-10 justify-center text-center">
                    ...
                    <div className="mt-5 mb-5">
                        <button className="border border-black rounded pl-16 pr-16 mr-10 hover:bg-teal-600 hover:text-white" onClick={handleYes}>Yes</button>
                        <button className="border border-black rounded pl-16 pr-16  hover:bg-teal-600 hover:text-white" onClick={handleNo}>No</button>
                    </div>
                    <p>{likes} out of {total} found this helpful</p>
                    <p className="mt-10">Have more questions? <NavLink to={'/support'} className="underline  hover:text-teal-600"> Submit a request </NavLink></p>
            ...
            <div className=" bg-gray-100">
                <div className="md:p-20">
                    ...
                    <div className="md:m-5 flex flex-wrap gap-10 justify-center">
                        <div className="w-[45%]">
                            <NavLink to={'/support'} >
                                <button className="text-nowrap border border-gray-500 w-full mb-4  hover:bg-teal-600 hover:text-white p-5 rounded">
                        ...
                        <div className="w-[45%]">
                            <NavLink to={'/art-advisory'}>
                                <button className="text-nowrap border border-gray-500 w-full mb-4  hover:bg-teal-600 hover:text-white rounded p-5">
